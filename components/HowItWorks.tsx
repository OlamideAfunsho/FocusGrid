...
const HowItWorks = () => {
  return (
    <>
    <div className='bg-[#F9F7FD] px-4 py-12 sm:p-12 lg:px-[120px] lg:py-16'>
        ...
        <p className='text-[20px] leading-9 text-[#6C7278] text-center'>Simple setup, powerful results. Start organizing your academic life today.</p>
        ...
        <div className='flex flex-wrap justify-center gap-6 mt-12 lg:mt-16'>
            <div className='flex flex-col items-center gap-2.5'>
                ...
                <p className='text-[20px] text-[#6C7278] leading-8'>Sign up with your email or university account. Takes less than 30 seconds.</p>
                </div>
            </div>
            ...
            <div className='flex flex-col items-center gap-2.5'>
                ...
                <p className='text-[20px] text-[#6C7278] leading-8'>Input your course schedule for the semester. We’ll create organized space for each class.</p>
                </div>
            </div>
            ...
            <div className='flex flex-col items-center gap-2.5'>
                ...
                <p className='text-[20px] text-[#6C7278] leading-8'>Start adding assignment , readings, and project. Set priorities and deadlines.</p>
                </div>
            </div>
            ...
            <div className='flex flex-col items-center gap-2.5'>
                ...
                <p className='text-[20px] text-[#6C7278] leading-8'>Track progress, use the study timer, and watch your productivity soar.</p>
                </div>
            </div>
        </div>
    </div>
