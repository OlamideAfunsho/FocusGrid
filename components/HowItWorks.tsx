...
const HowItWorks = () => {
  return (
    <>
      <div
        className="bg-[#F9F7FD] px-4 py-12 sm:p-12 lg:px-[120px] lg:py-16"
        id="how-it-works"
      >
          ...
          <div className="flex flex-col items-center gap-2.5">
            ...
            <div className="flex flex-col gap-4 bg-[#FFFFFF] w-[320px] lg:w-[282px] p-6 rounded-[12px] shadow-[0px_17px_29.7px_0px_#D1D8DF66]">
              <Image
                ...
                alt="user-icon"
                width={64}
                className=" bg-[#FEE2E2] rounded-[12px] p-5"
              />
              <h1 className="text-[24px] font-semibold">Create Account</h1>
              <p className="text[16px] lg:text-[20px] text-[#6C7278] leading-8">
                Sign up with your email or university account. Takes less than
                30 seconds.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-2.5">
            ...
            <div className="flex flex-col gap-4 bg-[#FFFFFF] w-[320px] lg:w-[282px] p-6 rounded-[12px] shadow-[0px_17px_29.7px_0px_#D1D8DF66]">
              <Image
                ...
                alt="bookmark-icon"
                width={64}
                className=" bg-[#DBEAFE] rounded-[12px] p-5"
              />
              <h1 className="text-[24px] font-semibold">Add Courses</h1>
              <p className="text[16px] lg:text-[20px] text-[#6C7278] leading-8">
                Input your course schedule for the semester. We’ll create
                organized space for each class.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-2.5">
            ...
            <div className="flex flex-col gap-4 bg-[#FFFFFF] w-[320px] lg:w-[282px] p-6 rounded-[12px] shadow-[0px_17px_29.7px_0px_#D1D8DF66]">
              <Image
                ...
                alt="tasks-icon"
                width={64}
                className=" bg-[#FCE7F3] rounded-[12px] p-5"
              />
              <h1 className="text-[24px] font-semibold">Add Tasks</h1>
              <p className="text[16px] lg:text-[20px] text-[#6C7278] leading-8">
                Start adding assignment , readings, and project. Set priorities
                and deadlines.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-2.5">
            ...
            <div className="flex flex-col gap-4 bg-[#FFFFFF] w-[320px] lg:w-[282px] p-6 rounded-[12px] shadow-[0px_17px_29.7px_0px_#D1D8DF66]">
              <Image
                ...
                alt="rocket-icon"
                width={64}
                className=" bg-[#F0FDF4] rounded-[12px] p-5"
              />
              <h1 className="text-[24px] font-semibold">Stay Organized</h1>
              <p className="text[16px] lg:text-[20px] text-[#6C7278] leading-8">
                Track progress, use the study timer, and watch your productivity
                soar.
              </p>
            </div>
          </div>
