...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  <div className="w-full md:w-[276px] h-fit md:h-full p-0 md:px-4 md:py-6 flex-shrink-0 md:flex-none border-t border-t-neutral-100 md:border-t-0 md:border-r-3 md:border-r-[#F9F9F9] bg-white z-10">
    <SideBar />
  </div>
